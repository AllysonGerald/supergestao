    ...
    <form action="{{ route('admin.fornecedores.update', $fornecedor) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div><label class="block text-sm font-medium text-gray-700 mb-2">CNPJ *</label><input type="text" name="cnpj" value="{{ old('cnpj', $fornecedor->cnpj) }}" required data-mask="cnpj" placeholder="00.000.000/0000-00" class="w-full px-4 py-2 border border-gray-300 rounded-lg"></div>
                ...
                <div><label class="block text-sm font-medium text-gray-700 mb-2">Telefone *</label><input type="text" name="telefone" value="{{ old('telefone', $fornecedor->telefone) }}" required data-mask="phone" placeholder="(00) 0000-0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg"></div>
                <div><label class="block text-sm font-medium text-gray-700 mb-2">Celular</label><input type="text" name="celular" value="{{ old('celular', $fornecedor->celular) }}" data-mask="phone" placeholder="(00) 00000-0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg"></div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div><label class="block text-sm font-medium text-gray-700 mb-2">CEP * <span class="text-xs text-gray-500">(auto-preenche)</span></label><input type="text" name="cep" value="{{ old('cep', $fornecedor->cep) }}" required data-mask="cep" data-cep-autofill placeholder="00000-000" class="w-full px-4 py-2 border border-gray-300 rounded-lg"></div>
